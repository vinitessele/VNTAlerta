                    ...
                    using (var db = new Context())
                    {
                        ...
                        while (line != null)
                        {
                            try
                            {
                                ...
                                {
                                    throw new System.InvalidOperationException("Ops Algo de errado com sua licença entre em contato com a VNT - Sistemas");
                                }
                            ...
                            {
                                MessageBox.Show("Ops Algo de errado com sua licença entre em contato com a VNT - Sistemas", "VNT - Sistemas");
                                throw;
                            }
                        }
                        sr.Close();
