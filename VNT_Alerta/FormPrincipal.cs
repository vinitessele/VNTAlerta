        ...
        private void AdicionaEstados()
        {
            try
            {
                using (var cmd = DbConnection(dataBasePath).CreateCommand())
                {
                    ...
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (16, 'Amapá', 'AP', 1)";
                    cmd.ExecuteNonQuery();
                    ...
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (23, 'Ceará', 'CE', 2)";
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (53, 'Distrito Federal', 'DF', 5)";
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (32, 'Espírito Santo', 'ES', 3)";
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (52, 'Goiás', 'GO', 5)";
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (21, 'Maranhão', 'MA', 2)";
                    cmd.ExecuteNonQuery();
                    ...
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (15, 'Pará', 'PA', 1)";
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (25, 'Paraíba', 'PB', 2)";
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (41, 'Paraná', 'PR', 4)";
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (26, 'Pernambuco', 'PE', 2)";
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (22, 'Piauí', 'PI', 2)";
                    cmd.ExecuteNonQuery();
                    ...
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (11, 'Rondônia', 'RO', 1)";
                    cmd.ExecuteNonQuery();
                    ...
                    cmd.ExecuteNonQuery();
                    cmd.CommandText = "Insert into Estado (CodigoUf, Nome, Uf, Regiao) values (35, 'São Paulo', 'SP', 3)";
                    cmd.ExecuteNonQuery();
