...
namespace VNT_Alerta
{
    public partial class FormPrincipal : Form
    {
        ...
        public FormPrincipal()
        {
            ...
            Boolean encerrarAplicacao = VerificaLicenca();
        ...
        private Boolean VerificaLicenca()
        {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                if (DateTime.Parse(textoDescriptografado) == e.dataInicioAtivacao)
                                                {
                                                    line = sr.ReadLine();
                                                    continue;
                                                }
                                                ...
                                                {
                                                    if (DateTime.Parse(textoDescriptografado) == e.dataFimAtivacao)
                                                    {
                                                        line = sr.ReadLine();
                                                        continue;
                                                    }
                                                    ...
                                                    {
                                                        MessageBox.Show("Ops Algo de errado com sua licença entre em contato com a VNT - Sistemas", "");
                                                        return false;
                                                    }
                                                }
                                            }
            ...
            {
                MessageBox.Show("Falha ao verificar Licença de uso do Software", "DB Creator");
                return false;
            }
        }
        ...
        private void AdicionaEstados()
        {
            ...
            if (qteRegistros == 0)
            {
                try
                {
                    using (var cmd = DbConnection(dataBasePath).CreateCommand())
                    {
                        cmd.CommandText = "Insert into Estado (id, Nome, Uf, Regiao) values " +
                                            "(27, 'Alagoas', 'AL', 2)," +
                                            "(16, 'Amapá', 'AP', 1)," +
                                            "(13, 'Amazonas', 'AM', 1)," +
                                            "(29, 'Bahia', 'BA', 2)," +
        ...
        private void AdicionaCidades()
        {
            ...
            if (qteRegistros == 0)
            {
                try
                {
                    using (var cmd = DbConnection(dataBasePath).CreateCommand())
                    {
                        cmd.CommandText = "INSERT INTO cidade (id, idestado, Nome) VALUES " +
